 ...
 * which can be used to change the currently loaded {@link VoiceSplittingParameters}.
 * 
 * @author Andrew McLeod - 4 August, 2015
 */
public class VoiceSplittingParametersDialog extends JDialog {
	/**
	 * 
	 */
	 ...
	 * @param gui {@link #gui}
	 */
	public VoiceSplittingParametersDialog(VoiceSplittingGUI gui) {
	...
	private Component getButtons() {
		...
		cancel.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				VoiceSplittingParametersDialog.this.dispose();
			}
		});
		panel.add(cancel);
