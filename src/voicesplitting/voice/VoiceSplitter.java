 ...
 * a single ordered List of MidiNotes, and return a List of {@link SingleNoteVoice}s, each List consisting
...
public interface VoiceSplitter {
	/**
	 * Get the {@link SingleNoteVoice}s we've split the song into.
	 * 
